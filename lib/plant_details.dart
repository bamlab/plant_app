        ...
        children: [
          Padding(
            ...
            child: Align(
              ...
              child: Text(
                "Strelitzia Nicolai",
                style: GoogleFonts.dmSerifDisplay(fontSize: 36, color: Color(0xFF23483F)),
              ),
            ),
          ),
          HeaderLabel(),
          Row(
            ...
            children: [
              Indicator(
                title: 'Water',
                color: Color.fromRGBO(83, 173, 255, 1),
          ...
          Padding(
            ...
            child: Text(
              ...
              style: GoogleFonts.nunitoSans(fontSize: 16, height: 1.5, color: Color(0xFF23483F)),
            ),
          ),
        ],
      ),
...
class HeaderLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Container(
        height: 35,
        margin: EdgeInsets.only(left: 43, bottom: 24),
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          Icon(Icons.face, size: 16, color: Color(0xFF438264)),
          SizedBox(width: 8),
          Text(
            'She likes your home !',
            style: GoogleFonts.nunitoSans(color: Color(0xFF438264)),
          )
        ]),
      ),
    );
        ...
        Padding(
          ...
          child: Text(widget.title,
              style: GoogleFonts.dmSerifDisplay(
                textStyle: TextStyle(fontSize: 16, color: Color(0xFF22483F)),
              )),
        ),
        IndicatorCircle(icon: widget.icon, percentage: widget.percentage, color: widget.color),
